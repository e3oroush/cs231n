...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        out, cache_conv_relu = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        ...
        loss += 0.5 * self.reg * (sum([np.sum(w*w) for k,w in self.params.items() if k.startswith('W')]))
        ...
        dout, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout, cache_conv_relu)
